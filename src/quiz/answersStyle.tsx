    ...
    return (
        <>
            <div className="fl fl-c m-t-40">
                <div className="fl fl-c pointer" onClick={() => setIsOpened(true)}>
            ...
            <Modal className="fl fl-j-c" isOpened={isOpened} onClose={() => setIsOpened(false)}>
                <div key={step}>
                    ...
                    <ButtonStyle
                        style={{
                            opacity: play ? 1 : 0,
                            transitionDelay: play ? '10s' : '0'
                        }}
                        className="m-t-40 p-20-20"
                        onClick={onNext}
                    >
                        {step >= 5 ? 'Aizvērt' : 'Nākamā'}
                    </ButtonStyle>
                </div>
            </Modal>
        </>
